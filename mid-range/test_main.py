...
def assert_pyside2():
    ...
    assert (
        QtWebEngineWidgets.QWebEnginePage is PySide2.QtWebEngineWidgets.QWebEnginePage
    )
...
def assert_pyqt5():
    ...
    if QtWebEngineWidgets.WEBENGINE:
        assert (
            QtWebEngineWidgets.QWebEnginePage is PyQt5.QtWebEngineWidgets.QWebEnginePage
        )
    else:
