from algorithms.maths.polynomial import Polynomial, Monomial
...
class TestSuite(unittest.TestCase):
    def setUp(self):
        ...
        self.p5 = Polynomial(
            [Monomial({150: 5, 170: 2, 10000: 3}, 0), Monomial({1: -1, 3: 2}, 1)]
        )
        self.p6 = Polynomial(
    ...
    def test_polynomial_addition(self):
        ...
        self.assertEqual(
            self.p2 + self.p3,
            Polynomial([Monomial({1: 2, 2: -1}, 1.5), Monomial({1: 1}, 4)]),
        )
    ...
    def test_polynomial_division(self):
        ...
        self.assertEqual(
            self.p3 / self.p2,
            Polynomial([Monomial({}, 1), Monomial({1: 1, 2: -1}, 0.75)]),
        )
        self.assertEqual(
            self.p7 / self.m1,
            Polynomial([Monomial({1: -1, 2: -3}, 2), Monomial({1: 0, 2: -4}, 1.5)]),
        )
        self.assertEqual(
            self.p7 / self.m1,
            Polynomial([Monomial({1: -1, 2: -3}, 2), Monomial({2: -4}, 1.5)]),
        )
        return
