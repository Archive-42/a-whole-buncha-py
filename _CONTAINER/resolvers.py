...
class Resolution(object):
    ...
    def _push_new_state(self):
        ...
        """
        base = self._states[-1]
        state = State(mapping=base.mapping.copy(), criteria=base.criteria.copy())
    ...
    def _get_preference(self, name):
        return self._p.get_preference(
            ...
            candidates=IteratorMapping(
                self.state.criteria, operator.attrgetter("candidates")
            ),
            information=IteratorMapping(
                self.state.criteria, operator.attrgetter("information")
            ),
        )
