...
def max_bit(n, k):
    maximum = (
        0
    )  # we need a counter to keep a check on the value of I & J, it should not exceed K
    for i in range(1, n + 1):
        for j in range(1, i):
            ...
            if (
                maximum == k - 1
            ):  # if maximum becomes equal to k-1, we have found the maximum value of I & J which will be less than K
                return maximum
    return maximum
