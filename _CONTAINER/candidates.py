    ...
    def _check_metadata_consistency(self, dist: Distribution) -> None:
        ...
        if self._name is not None and self._name != canonical_name:
            raise MetadataInconsistent(
                self._ireq, "name", self._name, dist.project_name
            )
...
class AlreadyInstalledCandidate(Candidate):
    ...
    def __init__(
        self, dist: Distribution, template: InstallRequirement, factory: "Factory"
    ) -> None:
        self.dist = dist
...
class ExtrasCandidate(Candidate):
    ...
    def __init__(self, base: BaseCandidate, extras: FrozenSet[str]) -> None:
        self.base = base
        self.extras = extras
